...
print
regresion_data.coef_  # this is the slope of optimam line
print
regresion_data.intercept_  # this is y intercept
...
print
'train accuracy ', regresion_data.score(x_train, y_train)
print
'test accuracy ', regresion_data.score(xtest, ytest)
...
print
'the r square value is ', rsqaure_value
print('the r square value is  or Variance score: %.2f' % rsqaure_value)
print
'mean square value', mean_squared_error(data['Salary'], regresion_data.predict(exp_Data))
