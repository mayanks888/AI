...
input_folder='/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/new_farm_imageS_with_correct_box_n_qual/apollo_result/Groundtruth'
base_ground_path="/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/new_farm_imageS_with_correct_box_n_qual/apollo_result/prediction_apollo"
new_ground_path="/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/new_farm_imageS_with_correct_box_n_qual/apollo_result/pred_rem"
output_folder='/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/new_farm_imageS_with_correct_box_n_qual/apollo_result/prediction_apollo'
for root, _, filenames in os.walk(input_folder):
    ...
    for filename in filenames:
            ...
            if not os.path.exists(base_ground_file_path):
                new_ground_file_path = (os.path.join(new_ground_path, filename))
                # with open(new_ground_file_path) as f:
                with open(new_ground_file_path, 'w') as f:
                    print(1)
