...
csv_path = '/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/new_farm_imageS_with_correct_box_n_qual/farm_eval_front_facing_light.csv'
...
save_path = "/media/mayank_sati/DATA/datasets/one_shot_datasets/Farmington/images/new_farm_imageS_with_correct_box_n_qual/evaluation/Groundthruth_front_facing"
