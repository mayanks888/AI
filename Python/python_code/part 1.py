...
print
datasets[['PassengerId', 'Name', 'Age']].head()

# finding rows based on some condition
print
datasets[datasets['Age'] > 25].head()
print
...
print
datasets.rename(columns={'new column': 'my column'}).head()
...
print
'the max age= ', datasets['Age'].max()
print
'the minimum age= ', datasets['Age'].min()
print
'the sum of all ags=', datasets['Age'].sum()
# finding the number of rows in particular age and this will also contain "NAN' data included
print
'total rows in age', datasets["Age"].count()
print
'the average(mean) is ', datasets["Age"].mean()
print
'the standard deviation is ', datasets["Age"].std()
print
' the unique value in datasets colume Sex', datasets["Sex"].unique()
# the value count function with give a count of each unique value
print
' the unique value in datasets colume Sex', datasets["Sex"].value_counts()
#
