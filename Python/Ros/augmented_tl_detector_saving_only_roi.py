...
#         # self.light_co=[]
    ...
    def subscribers_def(self):
        ...
        subs_topic = '/apollo/sensor/camera/traffic/image_short'
        self._sub = rospy.Subscriber( subs_topic , Image, self.img_callback, queue_size=10, buff_size=2**24)
    ...
    def img_callback(self, image_msg):
        # image_save_path='/home/mayank_sati/Desktop/label_traffic_light/new_roi_light/'
        image_save_path='./crop_roi_image/'
        ...
        color_path = image_save_path + str(st)+"_.jpg"
        # print(color_path)
        print(color_path)
        cv2.imwrite(color_path, image_np)
