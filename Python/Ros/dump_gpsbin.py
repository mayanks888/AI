...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "in_dir", default="", action="store", type=str, help="the input ros bag directory")

    # g_args = parser.parse_args()
    # file_name= "./2018-11-24-09-25-36/2018-11-24-09-25-38_0.bag"
    file_name = "/home/mayanksati/PycharmProjects/models/AI-Hamid/bags_tracker/2018-11-24-09-25-36"
    # dump_bag(g_args.in_dir)
    dump_bag(file_name)
    print
    "/tmp/gpsimu.bin is generated"
