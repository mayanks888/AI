...
def usage():
    ...
    " -----------------------------------  USAGE:  -------------------------------------------------"
    print
    " rosrun data_extraction extract_topic.py -b bag_file_name -o output_file_name -t topic_name"
    print
    ""
    print
    "  bag_file_name - path to ros .bag file containing ROS records"
    print
    "  output_file_name - full path to csv file to save records to. If an image topic is specified"
    print
    "                     then the images will be saved to the same directory as the output file "
    print
    "                     and named Image_0001.jpg, Image_0002.jpg, etc."
    print
    "  topic_name       - topic in bag file that contains ROS messages."
    print
    "  "
    print
    ...
    ""
    print
    "  Rosbag Extraction Script v1 - Shane Lynn - 3rd May 2012"
    print
    ""
    print
    " ---------------------------------------------------------------------------------------------"
...
def getHeader(msg):
    ...
    if (msgType == '_sensor_msgs__LaserScan'):
        headerRow = ["Time", "Header_sequence", "Header_secs", "Header_nsecs", \
                     "angle_min", "angle_max", "angle_increment", "time_increment", "scan_time", "range_min",
                     "range_max"]
