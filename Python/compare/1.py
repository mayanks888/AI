...
class LidarProcessSubnode: public
...
class Lidar64ProcessSubnode: public
...
class Lidar16ProcessSubnode: public
...
model
by
setting - -cnn_segmentation_config, which is
// defined in modules / perception / common / perception_gflags.cc.The
model is
// generally
located
at
...
Define
subnode
config in modules / perception / conf / dag_streaming.config:
// subnodes
{
// id: 1
