...
for loop in range(1500, len(features)):
    ...
    first_iou = OCV_8_mean_IOu.bb_intersection_over_union([xmin, ymin, xmax, ymax],
                                                          [xmin1, ymin1, xmax1, ymax1])  # blue Small box
    second_iou = OCV_8_mean_IOu.bb_intersection_over_union([xmin, ymin, xmax, ymax],
                                                           [xmin2, ymin2, xmax2, ymax2])  # red bigger box
