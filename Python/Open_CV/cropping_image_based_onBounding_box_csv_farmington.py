...
def  increase_bounding_box_scale_diff_aproach_and_set_lim500(img,mybbox,scale_width,scale_height,box_wd_limit=500,box_ht_limit=500):
    # print("old box",mybbox)
...
saving_path = "/home/mayank_sati/Desktop/mycropped_image/"
...
for ind,da1 in enumerate(sorted(mygroup.keys())):
    ...
    for read_index in index:
        ...
        new_box = increase_bounding_box_scale_diff_aproach_and_set_lim500(image_scale, old_bbox_val, scale_width=30, scale_height=13)
