...
rotated = cv2.warpAffine(color_image, m, dsize=(color_image.shape[1], color_image.shape[
    1]))  # color_image.shape[1] is way to find the width,height of image (try youself)
