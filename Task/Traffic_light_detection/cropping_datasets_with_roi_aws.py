...
csv_path = "/home/mayanksati/Documents/csv/BBD_daytime_train_single.csv"
...
for values in data:
    ...
    if (width_box < 30 or height_box < 30 or xmin < 200 or xmax > 1000):
        continue
    ...
    try:
        ...
        # cimg_read.shape[0]v2.putText(my_frame, str((kurtValue)), (50, 50), cv2.FONT_HERSHEY_SIMPLEX, .750, (0, 0, 255), lineType=cv2.LINE_AA)
        ...
        im_width = img_read.shape[1]
        im_height = img_read.shape[0]
