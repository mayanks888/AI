...
# csv_path='yolo1.csv'
show=False
csv_path='nuscene_manipulate_all_mini.csv'
# csv_path='/home/mayank_s/datasets/bdd/training_set/only_csv/front_light_bdd.csv'
# root='/home/mayank_s/datasets/nuscene/v1.0-mini/samples'
root=''
##################################################################3333
...
for ind, da1 in enumerate(sorted(mygroup.keys())):
    ...
    # new_da1=da1.split("samples/")[-1]
    new_da1=da1.split("v1.0-mini/")[-1]
    save_new_path=os.path.join(saving_path, new_da1)
    if (saving_path in save_new_path):
        print( "Found!")
