...
class Object_detect():
    ...
    def Laod_model_parameter(self):
        ...
        # PATH_TO_CKPT = "/home/mayanksati/PycharmProjects/Data_Science_new/Task/object_detector_2/training/ssd_resnet_50_fpn/baidu_havalus/frozen_inference_graph_frcnn.pb"
        PATH_TO_CKPT = "/home/mayanksati/PycharmProjects/Data_Science_new/Task/object_detector_2/training/ssd_resnet_50_fpn/faster_rcnn_gwm/frozen_inference_graph_20000.pb"
        ...
        PATH_TO_LABELS = "/home/mayanksati/PycharmProjects/Data_Science_new/Task/object_detector_2/training/bdd_traffic_label_map_simgle.pbtxt"
        ...
        for root, _, filenames in os.walk(input_folder):
            ...
            for filename in filenames:
                try:
                    ...
                    with open(
                            "/home/mayanksati/PycharmProjects/Data_Science_new/Task/object_detector_2/training/json/" + filename + ".json",
                            'w') as f:
                    ...
                    time_con = (time_end - time_start) * 1000
                    print("time consumed", time_con)
                    output_path = (os.path.join(output_folder, filename))
                    cv2.putText(image, str(round(time_con)), (100, 100), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 0, 255),
                                lineType=cv2.LINE_AA)
                    cv2.putText(image, res, (100, 130), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 0, 255),
                                lineType=cv2.LINE_AA)
...
def parse_args():
    ...
    # file_path="/home/ubuntu/Documents/traffic_light/random"
