...
class Object_detect():
    ...
    def Laod_model_parameter(self):
        ...
        # PATH_TO_CKPT = os.path.join(CWD_PATH, self.MODEL_NAME, 'frozen_inference_graph_30812.pb')
        # PATH_TO_CKPT = os.path.join(CWD_PATH, self.MODEL_NAME, 'frozen_inference_graph_120000.pb')
        # PATH_TO_CKPT = "/home/mayank_sati/pycharm_projects/Data_Science_new/Task/object_detector_2/training/ssd_resnet_50_fpn/faster_rcnn_gwm/fixed_sized_500/frozen_inference_graph_250k.pb"
        # PATH_TO_CKPT = "/home/mayank_sati/Documents/frozen_inference_trt.pb"
        # PATH_TO_CKPT = "/home/mayank_sati/Documents/frozen_inference_graph_trt_95670.pb"
        PATH_TO_CKPT = "/home/mayank_sati/Documents/rect/aws_95670_checkpoints/output/frozen_inference_graph.pb"
        # PATH_TO_CKPT = "/home/mayank_sati/Documents/frozen_inference_graph_95670.pb"
        # PATH_TO_CKPT = "/home/mayank_sati/pycharm_projects/Data_Science_new/Task/object_detector_2/training/ssd_resnet_50_fpn/faster_rcnn_gwm/fixed_sized_500/frozen_inference_graph_100000.pb"
        # PATH_TO_CKPT = "/home/mayank_sati/Documents/pb files/faster rcnn for color/frozen_inference_graph.pb"
...
def parse_args():
    ...
    file_path = "/home/mayank_sati/Documents/datsets/Rosbag_files/short_range_images/2018-11-24-09-31-33/Baidu_TL_dataset1"
...
# MODEL_NAME = 'training/ssd_resnet_50_fpn/retiananet'
