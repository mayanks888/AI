        ...
        for root, _, filenames in os.walk(input_folder):
            ...
            for filename in filenames:
                try:
                    ...
                    new_sess = tf.Session()
                    image_new = new_sess.run(image_2)
                    image_expanded = np.expand_dims(image_new, axis=0)
                    # print(res)
                    ###########################################################
...
def parse_args():
    ...
    file_path = "/home/ubuntu/PycharmProjects/ob_2/training/save_cropped_images_300"
    ...
    parser.add_argument('--output_path', help="Output folder",
                        default='/home/ubuntu/PycharmProjects/ob_2/training/output')
