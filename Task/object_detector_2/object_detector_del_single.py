...
class Object_detect():
    ...
    def Laod_model_parameter(self):
        ...
        # PATH_TO_CKPT = os.path.join(CWD_PATH, self.MODEL_NAME, 'frozen_inference_graph_250k.pb')
    ...
    def find_detection(self, input_folder, output_folder):
        """Function to detect images in input folder and save annotated image in an output directory.
            ...
            Args:
                input_folder        : Input  file (images) direcory directory.
...
def parse_args():
    # file_path="/home/mayank_sati/Documents/Rosbag_files/short_range_images/2018-11-24-09-30-08/Baidu_TL_dataset1"
    # file_path="/home/mayank_sati/Documents/datsets/Rosbag_files/short_range_images/2018-11-24-09-31-33/Baidu_TL_dataset1"
    # file_path="./training/save_cropped_images_300"
    file_path = "./training/image_25_tl"
...
# /home/mayanksati/PycharmProjects/Data_Science_new/Task/object_detector_2/training/ssd_resnet_50_fpn/single/newly_train__jan

# MODEL_NAME = 'training/ssd_resnet_50_fpn/single/newly_train__jan'
# "/home/mayank_sati/pycharm_projects/Data_Science_new/Task/object_detector_2/training/ssd_resnet_50_fpn/faster_rcnn_gwm/fixed_sized_500/frozen_inference_graph_14134.pb"
