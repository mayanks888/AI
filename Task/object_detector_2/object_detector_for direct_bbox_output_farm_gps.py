...
class Object_detect():
    ...
    def find_detection(self, input_folder, output_folder,min_score_thres=.0000001):
        ...
        base_image_path="/media/mayank_sati/DATA/datasets/traffic_light/seol-tl/images"
        ...
        for root, _, filenames in os.walk(input_folder):
            ...
            for filename in filenames:
                try:
                    ...
                    image_diff_channel = cv2.imread(file_path, 1)
                    image = cv2.cvtColor(image_diff_channel, cv2.COLOR_BGR2RGB)
                    ...
                    cv2.imwrite(output_path, image_diff_channel)
                    # Clean up
                    cv2.destroyAllWindows()
                    # vis_util.save_image_array_as_png(image, output_folder)
                    ########################################################333
                    save_path = '/media/mayank_sati/DATA/datasets/traffic_light/seol-tl/txt/prediction'
...
def parse_args():
    ...
    parser.add_argument('--input_path', help="Input Folder", default='/media/mayank_sati/DATA/datasets/traffic_light/seol-tl/txt/ground_truth_val')
