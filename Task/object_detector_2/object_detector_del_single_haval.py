        ...
        for root, _, filenames in os.walk(input_folder):
            ...
            for filename in filenames:
                try:
                    ...
                    # cv2.putText(image, "mayank", (100, 100), cv2.FONT_HERSHEY_TRIPLEX, 2.0, (0, 255, 0), lineType=cv2.LINE_AA)
                    # cv2.putText(image, res, (100, 200), cv2.FONT_HERSHEY_TRIPLEX, 2.0, (0, 255, 0), lineType=cv2.LINE_AA)
...
def parse_args():
    ...
    # file_path="/home/mayanksati/Documents/datasets/BDD/traffic_light__square_gwm/traffic_light_combined_to_train"
    ...
    # file_path="/home/mayanksati/Documents/datasets/BDD/ubuntu_aws_instance/Mayank_datastore/rosbag_images/2018-11-24-09-48-37/Baidu_TL_dataset1"
