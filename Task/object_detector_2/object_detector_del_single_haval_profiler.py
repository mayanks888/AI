        ...
        for root, _, filenames in os.walk(input_folder):
            ...
            for filename in filenames:
                try:
                    ...
                    time_start = time.time()
                    image_1 = tf.image.resize_image_with_crop_or_pad(image, target_height=300, target_width=300)
                    new_sess = tf.Session()
                    image = new_sess.run(image_1)
                    image_expanded = np.expand_dims(image, axis=0)
                    ...
                    cv2.putText(image, str(round(time_end - time_start) * 1000), (100, 100), cv2.FONT_HERSHEY_SIMPLEX,
                                1, (0, 255, 0), lineType=cv2.LINE_AA)
                    cv2.putText(image, res, (100, 200), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 0),
...
def parse_args():
    ...
    # file_path="/home/mayanksati/PycharmProjects/Data_Science_new/Task/object_detector_2/training/random_50_50"
