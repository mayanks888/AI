...
class Object_detect():
    ...
    def find_detection(self, input_folder, output_folder):
        ...
        ##################################################################33
        root = ''
        csv_path = "/home/mayank_sati/Desktop/label_traffic_light/gwm_data_all_final.csv"
                ...
                if int(numboxes) >= 1:
                    for i in range(0, int(numboxes)):
                        ...
                        if score > 0.3:
                            ...
                            # cv2.putText(image, str(round((time_end - time_start) * 1000)), (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), lineType=cv2.LINE_AA)
                            # cv2.putText(image, res, (50, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), lineType=cv2.LINE_AA)
                            # cv2.putText(image, light_color, (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), lineType=cv2.LINE_AA)

                            #############################################################3333
                            # '/home/mayank_sati/Desktop/label_traffic_light/roi_label_bins'
                            if light_color == 'red':
                                image_save_path = "/home/mayank_sati/Desktop/label_traffic_light/roi_label_bins/red/"
                            elif light_color == 'green':
                                image_save_path = "/home/mayank_sati/Desktop/label_traffic_light/roi_label_bins/green/"
                            elif light_color == 'yellow':
                                image_save_path = "/home/mayank_sati/Desktop/label_traffic_light/roi_label_bins/yellow/"
                            else:
                                image_save_path = "/home/mayank_sati/Desktop/label_traffic_light/roi_label_bins/black/"
                            ...
                            print(color_path)
                            cv2.imwrite(color_path, image_old)
                        #########################################################################
                        # Clean up
