            ...
            for filename in filenames:
                ...
                if filename.split('.')[-1] == 'jpg' or filename.split('.')[-1] == 'mp4':
                    try:
                        ...
                        print(
                            'ERROR...object detection failed for Filename: {fn} , Check file type '.format(fn=filename),
                            '\n')
                    else:
                        1
...
def parse_args():
    ...
    parser.add_argument('--input_path', help="Input Folder",
                        default='/home/mayanksati/PycharmProjects/Data_Science_new/Task/object_detector_2/training/output_video')
