...
max_review_lenth = 100  # to make sure all review have same no of word for ease our memory allocation
...
n_rnn = 256  # no of activation maps
r_nn_drpout = 0.2
...
model.add(SimpleRNN(n_rnn, dropout=r_nn_drpout))
...
model.load_weights(output_dir + "/weights.04.hdf5")  # zero-indexed
