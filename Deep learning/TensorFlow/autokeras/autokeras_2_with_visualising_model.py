...
clf = ak.ImageClassifier(
    path="/home/mayank_sati/pycharm_projects/tensorflow/traffic_light_detection_classification-master/traffic_light_classification/autokeras/visualise",
    verbose=True, augment=False)
...
x_train, y_train = load_image_dataset(csv_file_path=train_csv, images_path=train_image_path)
