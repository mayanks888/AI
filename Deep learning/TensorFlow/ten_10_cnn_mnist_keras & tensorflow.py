...
conv_1_layer = tf.keras.layers.Conv2D(filters=32, kernel_size=(6, 6), strides=(1, 1), activation='relu', padding='same',
                                      name='block1_conv1')(x_image)
max_pool_1 = tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool')(conv_1_layer)

conv_2_layer = tf.keras.layers.Conv2D(filters=64, kernel_size=(6, 6), strides=(1, 1), activation='relu', padding='same',
                                      name='block2_conv1')(max_pool_1)
