...
dm_3 = np.array([[[1, 5], [2, 7], [3, 9]], [[4, 7], [5, 63], [6,
                                                              78]]])  # creating 3 d matrix where dim=2, row=3,colm=2(here dim is like depth of matrix)
...
val3 = tf.constant([[[1, 5], [2, 7], [3, 9]], [[4, 7], [5, 63], [6, 78]]],
                   dtype=tf.float32)  # (3 dimsion matrix)(tensor of rank 3
