...
class roi_proposal_layer(object):
    ...
    def network(self):
        ...
        with tf.variable_scope('roi_proposal'):
            ...
            self.blobs = proposal_layer.rpn_label(rpn_bbox_cls_prob=self.rpn_cls_prob, rpn_bbox_pred=self.rpn_bbox_pred,
                                                  mode=self.mode,
                                                  im_dims=self.im_dims, feat_strides=self.rpn_net.feat_stride,
