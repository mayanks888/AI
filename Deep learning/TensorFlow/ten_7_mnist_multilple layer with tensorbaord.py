...
for i in range(epochs):
    ...
    mysumary, mycross_entropy, myaccuracy, all_cross_ent, _, Sof_output, y_input = sess.run(
        [summary_op, loss, accuray, cross_entropy_val, optimiser, ol_output, Actual_output],
        feed_dict={input_matrix: batch_x,
                   output_matrix: batch_y})
