...
class _VGG16Head(nn.Module):
    ...
    def predict(self, roi, delta_per_class, score, image_size, prob_threshold=0.5):
        ...
        # !!!!!
        delta_per_class = delta_per_class * torch.cuda.FloatTensor([0.1, 0.1, 0.2, 0.2]) + torch.cuda.FloatTensor(
            [0., 0., 0., 0.])
...
if __name__ == '__main__':
    ...
    bbox_out, class_out, prob_out = head.predict(rois, delta_per_class, score, image_size=(500, 500),
                                                 prob_threshold=0.2)
