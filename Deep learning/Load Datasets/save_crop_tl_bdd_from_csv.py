...
# csv_path='/home/mayank_s/codebase/AI/Machine_learning/Deep learning/Load Datasets/bosch_val.csv'
csv_path='/home/mayank_s/codebase/AI/Machine_learning/Deep learning/Load Datasets/data_format_yolo/BBD_daytime_train.csv'
# csv_path='/home/mayank_s/codebase/AI/Machine_learning/Deep learning/Load Datasets/bosch_train.csv'
# root='/home/mayank_s/datasets/bdd_bosch/data/images/val'
root='/home/mayank_s/datasets/bdd/bdd100k_images/bdd100k/images/100k/train'
saving_path = "/home/mayank_s/datasets/bdd/cropped_traffic_light_bdd"
...
for ind, da1 in enumerate(sorted(mygroup.keys())):
    ...
    for i,read_index in enumerate(index):
        # print(index)
        ...
        # image_np_2 = image_scale[cropped_roi.y_offset:cropped_roi.y_offset + cropped_roi.height+20, cropped_roi.x_offset:cropped_roi.x_offset+cropped_roi.width+20]
        image_np_2 = image_scale[int(y[read_index][1]):int(y[read_index][3]), int(y[read_index][0]):int(y[read_index][2])]
        # output_path = saving_path + ""da1
        output_path = os.path.join(saving_path, (str(i)+"_"+da1))
        #
        try:
            cv2.imwrite(output_path, image_np_2)
            # print(image_np_2.shape)
        except:
            print(image_np_2.shape)
