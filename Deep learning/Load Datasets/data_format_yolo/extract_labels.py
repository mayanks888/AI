...
json_data = open('/home/mayank_s/datasets/bdd/bdd100k_labels_release/bdd100k/labels/bdd100k_labels_images_val.json')
print("----- LOADING JSON -----")
data = json.load(json_data)

# Construct a dictionary
class_dict = {'bus','light','traffic light','person','bike','truck','motor','car','train','Rider',"traffic sign"}
